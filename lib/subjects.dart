...
class _SubjectsPageState extends State<SubjectsPage> {
  ...
  Future<void> addSubject() async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        showSuccessToast('Subject added successfully!');  // Toast de succès
      } else {
  ...
  Future<void> updateSubject(String id) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        fetchSubjects();
        Navigator.pop(context);
        showSuccessToast('Subject updated successfully!');  // Toast de succès
      } else {
  ...
  Future<void> deleteSubject(String id) async {
    try {
      ...
      if (response.statusCode == 200) {
        fetchSubjects();
        showSuccessToast('Subject deleted successfully!');  // Toast de succès
      } else {
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        title: Text(subject['subject_name'], style: TextStyle(fontWeight: FontWeight.bold)),
